    ...
    return (
        <div>
            <div className="px-5 sm:px-5 lg:px-24 2xl:px-40">
                    ...
                    <div className="relative border-l-3 border-pink-100 border-radius-2 pl-4 space-y-12 max-w-6xl mx-auto">
                        {[
                            ...
                            >
                                ...
                                <motion.div 
                                    className="bg-white p-6 shadow-sm border border-[#55555580]"
                                    whileHover={{
                ...
                {/* CEO Message Section */}
                <motion.div 
                    className="my-24 border border-[#55555580] bg-white px-6 py-16 max-w-full mx-auto text-center shadow-sm"
                    whileHover={{
                ...
                {/* Process Fit Callout */}
                <motion.div 
                    className="my-24 text-center border border-[#55555580]"
                    whileHover={{
                        borderColor: "#000",
                        transition: { duration: 0.3 }
                    }}
                ...
                <motion.div 
                    className="mt-20 text-center border border-[#55555580] py-16 px-6"
                    whileHover={{
                        borderColor: "#000",
                        transition: { duration: 0.3 }
                    }}
