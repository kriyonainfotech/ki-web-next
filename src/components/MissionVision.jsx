...
export default function MissionVision() {
    return (
        <>
            <section className="mt-20 py-16 px-5 sm:px-10">
                <div className="text-center mb-16">
                    <h2 className="text-lg ">Our Purpose</h2>
                    <h3 className="text-2xl md:text-3xl lg:text-4xl text-primary-black font-bold mt-2">
                        Driving <span className="">Digital Innovation</span>
                    </h3>
                </div>

                <div className="grid md:grid-cols-2 gap-10 max-w-5xl mx-auto">
                    <div className="p-8  shadow-sm border rounded-lg border-gray-200 relative overflow-hidden">
            ...
            <section className="py-16 px-5 sm:px-10">
                <div className="text-center mb-16">
                    <h3 className="text-2xl md:text-3xl lg:text-4xl text-primary-black font-bold mt-2">
                        Core <span className="">Values</span>
                    </h3>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5 max-w-7xl mx-auto">
                    {[
                        ...
                        <motion.div
                            key={index}
                            whileHover={{ y: -10 }}
                            className=" p-8 shadow-sm border rounded-lg border-gray-200 text-center"
                        >
